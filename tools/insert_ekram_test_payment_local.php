<?php
// Insert a test ekram fund, assignment and a payment row for diagnostics (local DB used by tools/query_ekram_payments.php)
$host = 'localhost';
$user = 'root';
$pass = '';
$db   = 'kharjamaat';
...
// Create a test fund
$title = 'Test Ekram Fund (local)';
$amount = 1000.00;
$hijri_year = 1447;
$description = 'Automated test fund (local)';
$created_by = null;
...
// Payment
$paid = 500.00;
$notes = 'Test payment via assistant (local)';
$method = 'Cash';
