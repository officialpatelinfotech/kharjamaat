...
echo "=== Users with empty/blank Full_Name ===\n";
$rows = $db->query("SELECT ITS_ID, First_Name, Surname, Full_Name FROM user WHERE TRIM(Full_Name) = '' OR Full_Name IS NULL LIMIT 10");
print_r($rows);
