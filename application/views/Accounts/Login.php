...
<style>
  /* ─── Reset page scroll only for this view ─── */
  body, html {
  ...
  .lp-root {
    ...
    /* Use dvh for mobile where 100vh includes browser chrome */
    height: calc(100dvh - var(--lp-nav-h, 57px));
    width: 100%;
    /* Background image fix: cover + centre + fallback colour */
    ...
    padding: 1rem;
    position: relative;
    /* Do NOT overflow: hidden here — it clips the bg image on iOS */
    box-sizing: border-box;
  }

  /* ─── Semi-transparent overlay so card stays readable over any bg ─── */
  .lp-root::before {
    content: '';
    position: absolute;
    inset: 0;
  ...
  /* ─── Decorative blobs (above overlay) ─── */
  .lp-bg-shape {
    position: absolute;
    border-radius: 50%;
    pointer-events: none;
  ...
  /* ─── Geometric SVG (same z-level as blobs) ─── */
  .lp-bg-svg {
    position: absolute;
    top: 0; left: 0;
  ...
  .lp-card {
    ...
    /* Allow card to scroll internally if screen is very short */
  ...
  .lp-input-suffix:hover { color: #b8860b; }
  ...
  .lp-show-row input[type="checkbox"] {
    accent-color: #b8860b;
  ...
  .lp-forgot:hover { color: #78520a; text-decoration: underline; }
  ...
  .lp-error i { font-size: 15px; flex-shrink: 0; }
...
<div class="lp-root">
  ...
  <div class="lp-card">
    ...
    <div class="lp-card-top">
      ...
      <h1 class="lp-org-name">Anjuman-e-Saifee</h1>
      <p class="lp-org-sub">Sign in to access your Jamaat dashboard</p>
    </div>
    ...
    <div class="lp-card-body">
      ...
      <div class="lp-section-label" aria-hidden="true">
        ...
        <span class="lp-section-text">Secure Login</span>
        <div class="lp-section-line"></div>
      </div>
      ...
      <form method="post" action="<?php echo base_url('/accounts/login'); ?>" id="login-form">
        ...
        <div class="lp-field">
          <label class="lp-label" for="id_username">
            <i class="ti ti-id-badge-2" aria-hidden="true"></i> ITS ID
          </label>
          <div class="lp-input-wrap">
            <i class="ti ti-fingerprint lp-input-icon" aria-hidden="true"></i>
        ...
        <div class="lp-field">
          ...
          <div class="lp-input-wrap">
            ...
            <button type="button"
                    class="lp-input-suffix"
                    id="lp-eye-btn"
                    aria-label="Toggle password visibility">
              <i class="ti ti-eye" id="lp-eye-icon" aria-hidden="true"></i>
            </button>
          </div>
        </div>

        <!-- Show password checkbox -->
        <div class="lp-show-row">
          <input type="checkbox" id="showPwd" onchange="lpTogglePwd()">
        ...
        <!-- Forgot password -->
        <a href="<?php echo base_url('/accounts/forgetpassword'); ?>" class="lp-forgot">
          Forgot password?
        </a>
...
<script>
  ...
  // Eye button syncs with checkbox
  document.getElementById('lp-eye-btn').addEventListener('click', function () {
    lpTogglePwd();
  });

  /*
   * Dynamically measure the actual navbar height and apply it via a
   * CSS custom property so both .lp-root height and .lp-card max-height
   * stay in sync without duplicating the value.
   */
  (function () {
