...
<div class="margintopcontainer">
  <div class="container pt-5">
    <div class="text-left mt-3">
      <a href="<?php echo base_url("accounts/home") ?>" class="btn btn-outline-secondary"><i class="fa-solid fa-arrow-left"></i></a>
    </div>
    <p class="h4 text-center mt-2" style="color:goldenrod; text-transform:uppercase">My Raza Submissions</p>
    <div class="container">
      <div class="row mt-2">
        <form class="form-inline d-flex mt-2 w-100">
          ...
          <thead>
            ...
            foreach ($raza as $r) { ?>
              <tr>
                ...
                <td>
                  <?php if ($r['coordinator-status'] == 0) { ?>
                    <button type="button" class="btn btn-sm btn-primary remove-form-row" onclick="redirectto('accounts/edit_raza/<?php echo $r['id'] ?>');"><i class="fa <?php echo $r["razaType_id"] == 2 ? "fa-eye" : "fa-pen-to-square"; ?>"></i></button>
