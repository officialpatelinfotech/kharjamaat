...
<div class="container margintopcontainer">
  <h2 class="heading text-center pt-5 mb-4">Manage Delivery Person</h2>
  <div class="row mb-4 mx-4">
    ...
    <div class="container col-12 col-md-6 mt-3 mt-md-0 text-right">
      <button id="add-delivery-person" class="btn btn-secondary"><i class="fa-solid fa-plus"></i> Add Delivery Person</button>
    </div>
  </div>
  <div class="container pt-3 hidden" id="delivery-person-form-container">
    <form method="POST" action="<?php echo base_url("Umoor/adddeliveryperson"); ?>" class="row">
  ...
  <div class="container">
    <form>
      <legend class="text-center pt-2 text-primary">List of Delivery Person</legend>
...
<script>
  ...
  $(".save-button").on("click", function(e) {
    ...
    $.ajax({
      url: "<?php echo base_url("Umoor/updatedeliveryperson"); ?>",
      method: "POST",
      data: {
        "dp_id": $dpId,
        "name": $nameFieldValue,
