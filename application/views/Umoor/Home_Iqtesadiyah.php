...
<div class="anj-root">
  ...
  <main class="anj-content">
    ...
    <div class="mob-bar">
      ...
      <span style="font-size:.82rem;font-weight:700;color:var(--text-2);">Iqtesadiyah Dashboard</span>
    </div>
    ...
    <div class="chart-container grouped-block">
      ...
      <div class="collapse show" id="collapseItsSabeelMatch">
        <div class="row px-3">
          <?php $CI =& get_instance(); $CI->load->model('MemberStatusM'); ?>
          <div class="col-6 col-md-3 mb-3"><a href="<?= base_url('Umoor/Mumineendirectory?its_sabeel_match=its_sabeel_both_khar') ?>" style="text-decoration:none;color:inherit;display:block;"><div class="overview-card"><div class="overview-icon" style="background:#f5e9c0;color:#b8860b;"><i class="fa fa-home"></i></div><div class="overview-body"><span class="overview-title"><?= htmlspecialchars(MemberStatusM::match_status_label('its_sabeel_both_khar')) ?></span><span class="overview-value"><?= (int)($stats['active_inactive']['its_sabeel_both_khar'] ?? 0) ?></span></div></div></a></div>
          <div class="col-6 col-md-3 mb-3"><a href="<?= base_url('Umoor/Mumineendirectory?its_sabeel_match=sabeel_khar_its_out') ?>" style="text-decoration:none;color:inherit;display:block;"><div class="overview-card"><div class="overview-icon" style="background:#ecfeff;color:#0891b2;"><i class="fa fa-external-link"></i></div><div class="overview-body"><span class="overview-title"><?= htmlspecialchars(MemberStatusM::match_status_label('sabeel_khar_its_out')) ?></span><span class="overview-value"><?= (int)($stats['active_inactive']['sabeel_khar_its_out'] ?? 0) ?></span></div></div></a></div>
          <div class="col-6 col-md-3 mb-3"><a href="<?= base_url('Umoor/Mumineendirectory?its_sabeel_match=its_khar_sabeel_out') ?>" style="text-decoration:none;color:inherit;display:block;"><div class="overview-card"><div class="overview-icon" style="background:#fff7ed;color:#b45309;"><i class="fa fa-sign-out"></i></div><div class="overview-body"><span class="overview-title"><?= htmlspecialchars(MemberStatusM::match_status_label('its_khar_sabeel_out')) ?></span><span class="overview-value"><?= (int)($stats['active_inactive']['its_khar_sabeel_out'] ?? 0) ?></span></div></div></a></div>
          <div class="col-6 col-md-3 mb-3"><a href="<?= base_url('Umoor/Mumineendirectory?its_sabeel_match=both_not_khar') ?>" style="text-decoration:none;color:inherit;display:block;"><div class="overview-card"><div class="overview-icon" style="background:#fef2f2;color:#b91c1c;"><i class="fa fa-ban"></i></div><div class="overview-body"><span class="overview-title"><?= htmlspecialchars(MemberStatusM::match_status_label('both_not_khar')) ?></span><span class="overview-value"><?= (int)($stats['active_inactive']['both_not_khar'] ?? 0) ?></span></div></div></a></div>
        </div>
      </div>
      ...
      <div class="col-md-12 mb-3">
        <div class="chart-container compact">
          <div class="section-header-standard">
            ...
            <div class="d-flex align-items-center">
              <a href="<?= base_url('Umoor/qardanhasana') ?>" class="btn btn-outline-secondary btn-sm mr-2" style="font-size: .75rem; border-radius: 6px; padding: 2px 8px; font-weight: 600;">View</a>
              <button class="collapse-toggle-btn" type="button" data-toggle="collapse" data-target="#collapseQHIqtesadiyah" aria-expanded="true"><i class="fa fa-chevron-down"></i></button>
            </div>
          </div>
          <div class="collapse show" id="collapseQHIqtesadiyah">
            <?php
            ...
            <div class="row text-center mb-2 mt-2">
              <div class="col-12 col-md-3 mb-2">
                <a href="<?= base_url('Umoor/qardanhasana/mohammedi') ?>" style="text-decoration:none;color:inherit;display:block;">
                  <div class="mini-card">
                    <div class="stats-value" style="color:var(--blue);">₹<?= format_inr((float)($qh_tot['mohammedi']??0)) ?></div>
                    <div class="stats-label">Mohammedi</div>
                  </div>
                </a>
              </div>
              <div class="col-12 col-md-3 mb-2">
                <a href="<?= base_url('Umoor/qardanhasana/taher') ?>" style="text-decoration:none;color:inherit;display:block;">
                  <div class="mini-card">
                    <div class="stats-value" style="color:var(--blue);">₹<?= format_inr((float)($qh_tot['taher']??0)) ?></div>
                    <div class="stats-label">Taher</div>
                  </div>
                </a>
              </div>
              <div class="col-12 col-md-3 mb-2">
                <a href="<?= base_url('Umoor/qardanhasana/husain') ?>" style="text-decoration:none;color:inherit;display:block;">
                  <div class="mini-card">
                    <div class="stats-value" style="color:var(--blue);">₹<?= format_inr((float)($qh_tot['husain']??0)) ?></div>
                    <div class="stats-label">Husain</div>
                  </div>
                </a>
              </div>
              <div class="col-12 col-md-3 mb-2">
                <a href="<?= base_url('Umoor/qardanhasana') ?>" style="text-decoration:none;color:inherit;display:block;">
                  <div class="mini-card">
                    <div class="stats-value" style="color:var(--green);">₹<?= format_inr((float)($qh_tot['total']??0)) ?></div>
