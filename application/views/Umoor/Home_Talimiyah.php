...
<div class="anj-root">
  ...
  <aside class="anj-sidebar" id="anjSidebar">
    ...
    <div class="sidebar-menu">
      ...
      <ul class="menu-list">
        <li><a class="menu-item" href="<?php echo base_url('Umoor/Mumineendirectory') ?>"><span class="menu-icon"><i class="fa fa-address-book"></i></span><span class="menu-label">Mumineen Directory</span></a></li>
        <li><a class="menu-item" href="<?php echo base_url('madresa') ?>"><span class="menu-icon"><i class="fa fa-book"></i></span><span class="menu-label">Madresa</span></a></li>
      </ul>
    </div>
  </aside>
  ...
  <main class="anj-content">
    ...
    <div class="mob-bar">
      ...
      <span style="font-size:.82rem;font-weight:700;color:var(--text-2);">Talimiyah Dashboard</span>
    </div>
  ...
  <button type="button" class="miqaat-nav-btn next"
    ...
    <div class="chart-container calendar-overview">
      ...
      <div class="collapse show" id="collapseCalendarAnjuman">
        <div class="row">
          <a href="<?= base_url('common/fmbcalendar?from=Umoor') ?>" class="col-12 col-md-4"><div class="stats-card"><div class="text-center"><h5>Miqaat Days</h5><div class="stats-value"><?= (int)$year_daytype_stats['miqaat_days'] ?></div></div></div></a>
          <a href="<?= base_url('common/fmbcalendar?from=Umoor') ?>" class="col-12 col-md-4"><div class="stats-card"><div class="text-center"><h5>Thaali Days</h5><div class="stats-value"><?= (int)$year_daytype_stats['thaali_days'] ?></div></div></div></a>
          <a href="<?= base_url('common/fmbcalendar?from=Umoor') ?>" class="col-12 col-md-4"><div class="stats-card"><div class="text-center"><h5>Holidays</h5><div class="stats-value"><?= (int)$year_daytype_stats['holiday_days'] ?></div></div></div></a>
        </div>
      </div>
    </div>
    <?php endif; ?>
