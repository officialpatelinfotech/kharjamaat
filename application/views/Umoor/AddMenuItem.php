...
<div class="container margintopcontainer">
  <h1 class="text-center pt-5 mb-5">Item List</h1>
  <div class="container mb-4 p-0">
    <a href="<?php echo base_url("Umoor/menulist") ?>" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i> Back</a>
  </div>
  <div class="item-list-container">
    <div class="filter-create-item-btn d-flex">
      <form method="post" action="<?php echo base_url("Umoor/filter_menu_item"); ?>" class="d-flex">
        ...
        <div class="clear-filter-btn">
          <a href="<?php echo base_url("Umoor/add_menu_item"); ?>" id="clear-filter" class="btn btn-secondary mx-3">Clear Filter</a>
        </div>
    ...
    <form method="post" action="<?php echo base_url("Umoor/insert_item_type") ?>" id="add-item-type" class="d-flex justify-content-evenly align-items-center mt-4">
    ...
    <form method="post" action="<?php echo base_url("Umoor/insert_menu_item") ?>" id="add-item-form" class="d-flex justify-content-evenly align-items-center mt-4">
      <div class="form-group flex-grow-1 mr-2">
            ...
            <?php foreach ($menu_items as $item) : ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="javascript:void(0);" id="edit-btn-<?php echo $item['id']; ?>" class="edit-btn btn btn-secondary" onclick="editMenuItem(<?php echo $item['id']; ?>)">Edit</a>
                  <a href="<?php echo base_url("Umoor/edit_menu_item/"); ?>" id="save-btn-<?php echo $item['id']; ?>" class="save-btn btn btn-success" onclick="saveItem(<?php echo $item['id']; ?>)">Save</a>
                  <a href="<?php echo base_url("Umoor/delete_menu_item/"); ?>" id="delete-btn-<?php echo $item['id']; ?>" class="delete-btn btn btn-danger" onclick="deleteItem(<?php echo $item['id']; ?>)">Delete</a>
                </td>
              </tr>
            <?php endforeach; ?>
          <?php else : ?>
