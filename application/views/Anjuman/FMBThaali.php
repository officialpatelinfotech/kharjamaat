    ...
    <div class="anj-header">
      <div class="anj-header-inner">
        <div class="anj-title-group">
          ...
          <h1 class="anj-title">FMB Thaali</h1>
        </div>
      </div>
    </div>
    ...
    <div class="row mt-4">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="module-card">
          <div class="text-center w-100 mb-3">
            ...
            <h5 class="card-title">Takhmeen Payment</h5>
            <p class="card-text">Receive Thaali Takhmeen Payments</p>
          </div>
          <a href="<?php echo base_url("anjuman/fmbthaalitakhmeen"); ?>" class="btn-custom">
            <i class="fa-solid fa-file-invoice-dollar"></i> Receive Payment
          </a>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="module-card">
          <div class="text-center w-100 mb-3">
            ...
            <h5 class="card-title">Thaali Delivery</h5>
            <p class="card-text">Manage Thaali Delivery Person & Substitutions</p>
          </div>
          <a href="<?php echo base_url("common/deliverydashboard?from=anjuman/fmbthaali"); ?>" class="btn-custom">
            <i class="fa-solid fa-arrow-right-to-bracket"></i> Delivery Dashboard
          </a>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="module-card">
          ...
          <a href="<?php echo base_url("common/fmbthaalimenu?from=anjuman/fmbthaali"); ?>" class="btn-custom">
            <i class="fa-solid fa-arrow-right-to-bracket"></i> Go to FMB Menu
          </a>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="module-card">
          <div class="text-center w-100 mb-3">
            ...
            <h5 class="card-title">Extra Thaali</h5>
