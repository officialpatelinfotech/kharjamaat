...
$rows = isset($qardan_hasana_rows) && is_array($qardan_hasana_rows) ? $qardan_hasana_rows : [];
?>
...
<div class="container-fluid margintopcontainer pt-5">
  <div class="d-flex align-items-center">
    <a href="<?= base_url('anjuman'); ?>" class="btn btn-sm btn-outline-secondary mr-2"><i class="fa-solid fa-arrow-left"></i></a>
  </div>

  <h4 class="text-center page-title">Qardan Hasana Details</h4>
  ...
  <div class="card">
    <div class="card-body">
      <div class="details-table-container">
        <table class="table table-striped table-bordered details-table" id="qardanHasanaTable">
          <thead>
            <tr>
          ...
          <tbody>
            <?php if (empty($rows)) { ?>
              <tr>
                <td colspan="6" class="text-center text-muted">No qardan hasana records found.</td>
              </tr>
            <?php } else {
              $i = 1;
              foreach ($rows as $r) {
...
<script>
  (function() {
    ...
    var table = document.getElementById('qardanHasanaTable');
