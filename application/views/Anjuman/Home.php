  ...
  <div class="row">
    ...
    <div class="col-md-8 col-lg-9">
      ...
      <div class="chart-container grouped-block">
        ...
        $groups1 = [
          'health_status' => ['label' => 'Health Status', 'icon' => 'fa-heartbeat', 'bg' => '#fff1f2', 'color' => '#e11d48', 'count_key' => 'health', 'id' => 'collapseHealth'],
          'deeni_status' => ['label' => 'Deeni Status', 'icon' => 'fa-star', 'bg' => '#f5f3ff', 'color' => '#7c3aed', 'count_key' => 'deeni', 'id' => 'collapseDeeni'],
          'residential_status' => ['label' => 'Residential Status', 'icon' => 'fa-building', 'bg' => '#f0f9ff', 'color' => '#0369a1', 'count_key' => 'residential', 'id' => 'collapseResidential'],
                ...
                <div class="row">
                  ...
                  <?php if (!empty($ms)) {
                    foreach ($ms as $label => $count) {
                      if (strtolower(trim((string)$label)) === 'unknown' || strtolower(trim((string)$label)) === 'single') continue;
