...
<div class="container margintopcontainer pt-5">
  <div class="row mb-3">
    <div class="col-6">
      <a href="<?php echo base_url('anjuman/laagat_rent'); ?>" class="btn btn-outline-secondary" aria-label="Back to Dashboard"><i class="fa-solid fa-arrow-left"></i></a>
    </div>
    <div class="col-6 d-flex justify-content-end text-right text-end">
      <a href="<?php echo base_url('anjuman/laagat_rent_add'); ?>" class="btn btn-primary" aria-label="Create New Laagat/Rent Form">
  ...
  <div class="card shadow-sm">
    <div class="card-body">
      ...
      <form method="get" action="<?php echo site_url('anjuman/laagat_rent_master'); ?>" class="mb-4">
        <?php
        ...
        <div class="border rounded p-4">
          ...
          <div class="form-row align-items-end">
            ...
            <div class="form-group col-12 col-md-4 mb-0 d-flex justify-content-md-end mt-3 mt-md-0">
              <a href="<?php echo site_url('anjuman/laagat_rent_master'); ?>" class="btn btn-outline-secondary mr-2">Reset</a>
            ...
            <?php if (!empty($rows) && is_array($rows)) : ?>
              ...
              <?php foreach ($rows as $r) : ?>
                <tr>
                  ...
                  <td>
                    <a class="btn btn-sm btn-outline-primary" href="<?php echo site_url('anjuman/laagat_rent_add') . '?edit=' . (int)$r['id']; ?>">Edit</a>

                    <form method="post" action="<?php echo site_url('anjuman/laagat_rent_toggle'); ?>" style="display:inline-block;">
                    ...
                    <form method="post" action="<?php echo site_url('anjuman/laagat_rent_delete'); ?>" style="display:inline-block;" onsubmit="return confirm('Delete this record?');">
                      <input type="hidden" name="id" value="<?php echo (int)$r['id']; ?>" />
