...
<div id="anjApp" class="margintopcontainer pt-5">
  <div class="container-fluid px-md-5 pb-4">
    ...
    <!-- Back Button -->
    <div class="mb-4">
      <a href="<?php echo base_url($active_controller ? $active_controller : 'Umoor') ?>" class="btn btn-back">
      ...
      <div id="takhmeen-filters" class="filter-bar">
        <div class="form-row">
          ...
          <div class="col-12 col-md-2 mb-2">
            ...
            <form method="post" action="<?php echo base_url('common/fmbthaalitakhmeen'); ?>" class="m-0">
                ...
                <tr class="clickable-row" data-its-id="<?php echo htmlspecialchars((string)($user['ITS_ID'] ?? ''), ENT_QUOTES); ?>">
                  ...
                  <td>
                    <div class="d-flex flex-column gap-1">
                      ...
                      <?php endif; ?>
                      <?php if ($user["overall_due"] > 0 && !in_array((int)$_SESSION['user']['role'], [9, 12], true)): ?>
  ...
  <!-- Receive Takhmeen Payment Modal (Only for non-role 12) -->
...
<script>
  ...
  $('#apply-filters-btn').on('click', function(e) {
    e.preventDefault();
    var base = '<?php echo site_url('common/fmbthaalitakhmeen'); ?>';
  ...
  function openPaymentHistoryModal(user_id, name) {
    ...
    $.ajax({
      url: "<?php echo base_url('common/getPaymentHistory/1'); ?>",
      type: "POST",
      data: {
        user_id: user_id
      },
