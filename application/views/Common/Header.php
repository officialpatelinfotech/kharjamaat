    ...
    <div id="sj-navbar-collapse" class="collapse navbar-collapse">
      ...
      <ul class="navbar-nav navbar-right">
        <!-- <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            <a href="<?php echo $active_controller . "/update-profile/"; ?>" class="dropdown-item">
              <i class="fa fa-edit px-1"></i>Update Profile
            </a>
            <a href="<?php echo base_url('/accounts/changepassword/') ?>" class="dropdown-item">
