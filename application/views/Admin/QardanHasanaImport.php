<div class="container margintopcontainer">
  <div class="row align-items-center pt-3 mb-2">
    <div class="col-3 text-left">
      <a href="<?php echo base_url('admin/qardan_hasana'); ?>" class="btn btn-sm btn-outline-secondary" title="Back" aria-label="Back"><i class="fa fa-arrow-left"></i></a>
    </div>
    <div class="col-6 text-center">
      <h2 class="m-0">Import Latest Qardan Hasana Data</h2>
    </div>
    <div class="col-3 text-right">
      <a href="<?php echo base_url('admin/qardan_hasana_export'); ?>" class="btn btn-sm btn-success">&#x2B07; Export Current</a>
    </div>
  </div>
  <hr>
  ...
  <div class="card p-3 mb-3">
    ...
    <form method="post" enctype="multipart/form-data" id="qardan-hasana-import-form">
      ...
      <div class="mt-3">
        ...
        <a href="<?php echo base_url('admin/qardan_hasana_template'); ?>" class="btn btn-outline-secondary">Download 5-Row Template</a>
      </div>
    </form>
