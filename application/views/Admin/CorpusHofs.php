...
<div class="container margintopcontainer pt-5">
  ...
  <form id="hofFilters" class="mb-3 p-3 border rounded bg-light">
    <div class="row">
      ...
      <div class="col-md-2 mb-2">
        <label class="small text-muted mb-1">Hijri Year</label>
        <select class="form-control form-control-sm" id="filterHijriYear">
          <option value="">All</option>
          <?php if (isset($hijri_years) && !empty($hijri_years)): foreach ($hijri_years as $yr): ?>
  ...
  <div class="card shadow-sm">
    <div class="card-body p-0">
      <div class="table-responsive">
        <table class="table table-striped table-hover m-0" id="hofCorpusTable">
          <thead>
            <tr>
  ...
  <div class="modal-dialog" role="document" style="max-width:600px; margin:60px auto; width:95%;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Corpus Funds</h5>
...
<script>
  ...
  (function() {
    ...
    [].forEach.call(document.querySelectorAll('.view-funds-btn'), function(btn) {
      btn.addEventListener('click', function() {
        ...
        if (titleEl) {
          titleEl.textContent = 'Corpus Funds';
        }
        ...
        html += '<thead><tr><th>Fund Title</th><th>Amount (₹)</th><th>Actions</th></tr></thead><tbody>';
        ...
        [].forEach.call(form.querySelectorAll('.edit-fund-btn'), function(eb) {
          eb.addEventListener('click', function() {
            ...
            actionsCell.querySelector('.row-save-btn').addEventListener('click', function() {
              ...
              $.ajax({
                url: '<?php echo site_url('admin/corpusfunds_update_assignments'); ?>',
                method: 'POST',
                data: payload,
                processData: false,
                contentType: false,
  ...
  (function() {
    ...
    const yearSelect = document.getElementById('filterHijriYear');
  ...
  (function() {
    const table = document.getElementById('hofCorpusTable');
    if (!table) return;
