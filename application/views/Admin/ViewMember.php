...
<div class="panel mb-4">
  ...
  <div class="panel-bd" id="grp-sanstha-memberships">
    <div style="padding:16px;">
      ...
      <?php else: ?>
        <div style="text-align:center;padding:14px;color:var(--text-3);font-size:0.82rem"><i class="fa fa-info-circle"></i> Member is not assigned to any Sanstha currently.</div>
      <?php endif; ?>
    </div>
  </div>
</div>
