              ...
              <div class="col-md-4 col-12 mb-2">
                ...
                <select name="Member_Type" id="editMemberTypeSelect" class="form-control form-select form-select-sm">
                  ...
                  <optgroup label="── Permanent Residents ──">
                    ...
                    <option value="Resident Mumineen" <?php echo $mt == 'Resident Mumineen' ? 'selected' : ''; ?>>
                      Resident Mumineen — Lives in <?php echo $jp; ?>, ITS registered here, regular Sabeel payer
                    </option>

                    <option value="Moved-Out Mumineen" <?php echo $mt == 'Moved-Out Mumineen' ? 'selected' : ''; ?>>
                      Moved-Out Mumineen — ITS registered in <?php echo $jp; ?>, but no longer residing
                    </option>

                    <option value="Transfer Out" <?php echo $mt == 'Transfer Out' ? 'selected' : ''; ?>>
                      Transfer Out — Old member, ITS transferred to another Jamaat
                    </option>

                    <option value="Wafat" <?php echo $mt == 'Wafat' ? 'selected' : ''; ?>>
                      Wafat — Member of <?php echo $jp; ?> who has passed away
                    </option>

                    <option value="Married Outcast" <?php echo $mt == 'Married Outcast' ? 'selected' : ''; ?>>
                      Married Outcast — Married outside Jamaat, ITS transferred elsewhere
                    </option>

                    <option value="External Sabeel Payers" <?php echo $mt == 'External Sabeel Payers' ? 'selected' : ''; ?>>
                      External Sabeel Payers — ITS not in <?php echo $jp; ?>, resident & regular Sabeel payer
                    </option>

                  </optgroup>

                  <optgroup label="── Temporary / Non-Sabeel ──">

                    <option value="Non-Sabeel Residents" <?php echo $mt == 'Non-Sabeel Residents' ? 'selected' : ''; ?>>
                      Non-Sabeel Residents — Living in <?php echo $jp; ?>, ITS not here, not a Sabeel payer
                    </option>

                    <option value="Temporary Mumineen/Visitors" <?php echo $mt == 'Temporary Mumineen/Visitors' ? 'selected' : ''; ?>>
                ...
                <div id="editMemberTypeError" class="text-danger small mt-1" style="display:none;">
                </div>
              </div>
            </div>
          </div>
