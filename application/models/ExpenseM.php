...
class ExpenseM extends CI_Model
{
    ...
    public function get_list($filters = [])
    {
            ...
            $this->db->select('e.*, i.sector_name, i.sector_code, i.sub_sector_name, i.sub_sector_code, i.item_name, i.item_code, a.name AS area_name')
    ...
    public function update($id, $data)
    {
        ...
        if (array_key_exists('area_id', $data)) $payload['area_id'] = ($data['area_id'] !== '' && $data['area_id'] !== null) ? (int)$data['area_id'] : null;
        if (isset($data['amount'])) $payload['amount'] = (float)$data['amount'];
        if (isset($data['payment_mode'])) $payload['payment_mode'] = $data['payment_mode'] !== '' ? $data['payment_mode'] : null;
